...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/moviefireentertainment1')
            ],
            [
                InlineKeyboardButton('⚡ Owner ⚡', url=f"https://t.me/Movefireadminbot "),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Owner  ⚡', url='https://t.me/Movefireadminbot'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/moviefireentertainment1')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://t.me/moviefireentertainment1') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
